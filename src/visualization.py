...
def compare_roc_curves(true_labels_with_pretrain, predicted_probs_with_pretrain,
    ...
    fpr_with_pretrain, tpr_with_pretrain, _ = roc_curve(true_labels_with_pretrain, predicted_probs_with_pretrain)
    roc_auc_with_pretrain = auc(fpr_with_pretrain, tpr_with_pretrain)

    # ROC curve for the model without pretraining
    fpr_without_pretrain, tpr_without_pretrain, _ = roc_curve(true_labels_without_pretrain,
    ...
    plt.plot(fpr_with_pretrain, tpr_with_pretrain, color='blue', lw=2,
             label=f'With Pretraining (AUC = {roc_auc_with_pretrain:.2f})')
    plt.plot(fpr_without_pretrain, tpr_without_pretrain, color='red', lw=2,
